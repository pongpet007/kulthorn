			...
			<div class="col-lg-7 col-sm-6 animate__animated animate__slideInLeft">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item color-menu" aria-current="page"><a href="#">เกร็ดความรู้</a></li>
						<li class="breadcrumb-item  color-menu-active active" aria-current="page">หัวข้อเกร็ดความรู้</li>
					</ol>
				</nav>
		...
		<div class="row">
			<div class="col-lg-8 animate__animated animate__fadeInUp" style="animation-duration: 1.5s;"> 
				...
				<div class="img-knowledge">
					<img src="<?=base_url()?>assets/img/pro-about-1.png">
				</div>
				...
				<h3 class="h3-know-advice" style="font-weight: bold; ">เนื้อหาแนะนำที่เกี่ยวข้อง</h3 style="font-weight: bold; ">
					...
					<div class="container">
						<div class="row">
							...
							<div class="owl-carousel owl-theme owl-carousel-knowledge-about">
								<div class="item">
